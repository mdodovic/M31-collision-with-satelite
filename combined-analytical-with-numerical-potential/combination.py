...
fileNonDinamicalFriction = "C:\\Users\\Matija\\Desktop\\Projekat_2018_dinamicko_trenje\\analiticki_potencijal\\JuzniTok\\haloAP_BezTrenja\\"
fileDinamicalFriction = "C:\\Users\\Matija\\Desktop\\Projekat_2018_dinamicko_trenje\\analiticki_potencijal\\JuzniTok\\haloAP_SaTrenjem\\"
fileNumericalPotential = "C:\\Users\\Matija\\Desktop\\Projekat_2018_dinamicko_trenje\\numericalPotential\\1Case\\results\\"
outputImages = "C:\\Users\\Matija\\Desktop\\Projekat_2018_dinamicko_trenje\\combinedAnalitycalNumericalPotential\\dwarfWithoutDisk\\"
...
#    numerical = mlines.Line2D([], [], color='red', markersize=15, label='numericki',linestyle = '-')
    ...
    nonFriction_black = mlines.Line2D([], [], color='black', markersize=15, label='bez trenja', linestyle = ':')
    Friction_black = mlines.Line2D([], [], color='black', markersize=15, label='sa trenjem',linestyle = '-')
    numerical_black = mlines.Line2D([], [], color='black', markersize=15, label='numerički',linestyle = '--')
...
#    plt.plot(radiusA, massA, linestyle='--', color='black')
    ...
    plt.plot(tNum, eNum, c = 'black', linestyle = '--')    
    plt.plot(tNDF, eNDF, c = 'black', linestyle = ':')
    plt.plot(tDF, eDF, c = 'black', linestyle = '-')
    plt.legend(handles=[nonFriction_black,Friction_black,numerical_black], loc='lower left', prop={'size': 13})
    plt.xlabel(r"$T$ [Gyr]")
    plt.ylabel(r"$E [M_\odot\ kpc^2 / s^2]$")    
    plt.savefig(outputImages + "energy_crno.png", dpi = 300)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/energija_crno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika4.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika4.eps", dpi = 90)
    plt.show()    
    ...
    plt.plot(tNum, rNum, c = 'black', linestyle = '--')
    plt.plot(tNDF, rNDF, c = 'black', linestyle = ':')
    plt.plot(tDF, rDF, c = 'black', linestyle = '-')
    plt.xlabel(r"$T$ [Gyr]")
    plt.ylabel(r"$R$ [kpc]")
    plt.legend(handles=[nonFriction_black,Friction_black, numerical_black], loc='lower left', prop={'size': 13})
#    plt.savefig(outputImages + "radius.png", dpi = 300)
    plt.savefig(outputImages + "radius_crno.png", dpi = 300)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/radijus_crno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika3.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika3.eps", dpi = 90)
    ...
    plt.plot(xNum, yNum, c='black', linestyle = '--')
    plt.plot(xNDF, yNDF, c='black', linestyle = ':')
    plt.plot(xDF, yDF, c='black', linestyle = '-')
    plt.xlim(100, -100)
    #plt.ylim(-70, 70)
    plt.xlabel("X [kpc]")  # , fontsize=15)
    plt.ylabel("Y [kpc]")  # , fontsize=15)
    plt.errorbar(x, y, yerr, xerr, fmt='', color='black', linestyle="None")
    plt.legend(handles=[nonFriction_black, Friction_black, numerical_black], loc=7)
    plt.savefig(outputImages + "trajectory.png", dpi=300)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/trajectory_crno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika5Levo.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika5Levo.eps", dpi = 90)
    ...
    plt.legend(handles=[nonFriction_black, Friction_black, numerical_black], loc=7)
    plt.savefig(outputImages + "trajectoryZoom.png", dpi=300)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/trajectoryZoom_crno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika5Desno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika5Desno.eps", dpi = 90)
    plt.show()
    ...
    plt.plot(mDF, dDF, c='black', linestyle = '-')
    plt.plot(mNDF, dNDF, c='black', linestyle = ':')
    plt.plot(mNum, dNum, c='black', linestyle = '--')
    plt.xlim(-1, 7)
    plt.ylim(0, 150)
    plt.xlabel("m [\N{DEGREE SIGN}]")  # , fontsize=15)
    plt.ylabel("R [kpc]")  # , fontsize=15)
    plt.errorbar(xDubinaField, yDubinaField, yerrDubina, xerrDubina, fmt='', color = 'black',linestyle="None")
    plt.legend(handles=[nonFriction_black, Friction_black, numerical_black], loc='best')
    plt.savefig(outputImages + "dubinaZoom.png", dpi=300)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/dubinaZoom_crno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika6Desno.png", dpi = 90)
    plt.savefig("C:/Users/Matija/Desktop/Projekat_2018_dinamicko_trenje/analiticki_potencijal/graficiRad/vektorski/slika6Desno.eps", dpi = 90)
    plt.show()
